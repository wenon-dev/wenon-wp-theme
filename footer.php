	...
	<div class="container" id="footer">
		<div class="container-fluid">
			...
			<div class="footer-infos">
				...
				<p>TGYZ.ITD <span class="glyphicon glyphicon-time" aria-hidden="true" onclick="location.href='easter_egg.html'"></span> Ver. RENEW</p>
				<p onclick="location.href='Mailto:tgyzwn@163.com'"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span> tgyzwn@163.com</p>
			</div>
